              ...
              <div class="col-8 mx-auto">
                ...
                <form action="" method="post">
                  <div class="form-group">
                    ...
                    <input autocomplete="off" autofocus="on" type="text" name="lokasi" id="lokasi" class="form-control" placeholder="Masukkan Lokasi Anda">
                  </div>
                  <div class="form-group">
                    <label for="">Bobot</label>
                    <input autocomplete="off" autofocus="on" type="number" name="bobot" id="bobot" class="form-control" placeholder="Masukkan Bobot MIN 0,5 Kg">
                  </div>
                  <div class="form-group">
                    <label for="">Tanggal</label>
                    <input autocomplete="off" autofocus="on" type="date" name="tanggal" id="tanggal" class="form-control" placeholder="Masukkan Y-M-D saat ini">
                  </div>
                  <div class="form-group">
